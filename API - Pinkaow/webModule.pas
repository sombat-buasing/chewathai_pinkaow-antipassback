...
var
  WebModuleClass: TComponentClass = TwmModule;
    alpetaUser : string;
...
procedure TwmModule.WebModuleCreate(Sender: TObject);
begin
...
//  FMVC.AddController(TControllerQrcode);
  FMVC.AddController(TControllerBroadOnOff);
  FMVC.AddController(TControllerCarparkDB);
...
procedure TwmModule.WebModuleDestroy(Sender: TObject);
begin
  FMVC.Free;
end;
